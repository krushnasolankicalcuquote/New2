...
$zipPath = 'Q:\PipelineData\EU-GDPR\CommonServices'
$extrectPath = 'Q:\PipelineData\Inetpub\EU-GDPR\CommonServices'
$destinationPath ='Q:\Inetpub\EU-GDPR\CommonServices'

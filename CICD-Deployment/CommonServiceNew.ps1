...
$extrectPath = "Q:\PipelineData\Inetpub\CommonServices"

try{
$data = @(

       [pscustomobject]@{FolderName=$zipPath +'\CQ_CustomReport.zip';serviceName ='CQ_Common_CustomReport';ExtractPath= $extrectPath + '\CQ_CustomReport';}
   )
